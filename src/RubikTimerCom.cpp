...
RubikTimer::RubikTimer()
{
    ...
    timesPath = QString("/home/nemo/.local/share/CubeTimer/times.sav");
    settingsPath = QString("/home/nemo/.local/share/CubeTimer/settings.sav");

    QDir dir("/home/nemo/.local/share");
    if(!dir.exists("/home/nemo/.local/share/CubeTimer"))
    {
        dir.mkdir("CubeTimer");
    }
